...
<div class="profile-page-wrapper" style="background-color: #f8fafc; width: 100%; padding: 40px 30px;">
    <div class="profile-content-area" style="max-width: 1100px; margin: 0 auto;">
            ...
            <!-- <?php if(session('success')): ?>
                <script>
                    setTimeout(function() {
                        window.location.href = "<?php echo e(route('frontend.independent-contractor.dashboard')); ?>";
                    }, 3000);
                </script>
            <?php endif; ?> -->

            <form action="<?php echo e(route('frontend.profile.update')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div style="flex-grow: 1;">
                            ...
                            <div class="profile-form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" value="<?php echo e(old('first_name', $user->first_name)); ?>" style="width: 100%; padding: 14px 18px; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 16px; color: #1e293b; background: #f8fafc; outline: none; transition: all 0.2s;">
                                    <?php $__errorArgs = ['first_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <small style="color: #ef4444; font-size: 12px; margin-top: 5px; display: block;"><?php echo e($message); ?></small> <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="last_name" value="<?php echo e(old('last_name', $user->last_name)); ?>" style="width: 100%; padding: 14px 18px; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 16px; color: #1e293b; background: #f8fafc; outline: none;">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" value="<?php echo e(old('phone', $user->phone)); ?>" style="width: 100%; padding: 14px 18px; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 16px; color: #1e293b; background: #f8fafc; outline: none;" placeholder="+1 (555) 000-0000">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" readonly style="width: 100%; padding: 14px 18px; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 16px; color: #1e293b; background: #f8fafc; outline: none;">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="profile-image-section">
                            <div style="position: relative;">
                                <?php if($user->image): ?>
                                    <img src="<?php echo e(asset('uploads/profile/' . $user->image)); ?>" id="preview-img" alt="Profile" style="width: 200px; height: 200px; border-radius: 50%; object-fit: cover; box-shadow: 0 10px 25px -5px rgba(0,0,0,0.1);">
                                <?php else: ?>
...
<?php echo $__env->make('user-layout.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Time-Mattercsss\resources\views/user-layout/profile.blade.php ENDPATH**/ ?>