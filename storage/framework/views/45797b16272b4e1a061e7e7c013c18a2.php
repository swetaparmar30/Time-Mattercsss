...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" style="width: 100%; padding: 14px 18px; border: 1px solid #e2e8f0; border-radius: 12px; font-size: 16px; color: #1e293b; background: #f8fafc; outline: none;">
