...
unset($__errorArgs, $__bag); ?>
      ...
      <section id="forgot-password-section" class="auth-panel-hidden">
        ...
        <form class="auth-form" action="<?php echo e(route('frontend.password.email')); ?>" method="POST">
          <?php echo csrf_field(); ?>
          <div class="form-field">
...
<?php /**PATH C:\laragon\www\Time-Mattercsss\resources\views/frontend/auth/login.blade.php ENDPATH**/ ?>