                        ...
                        <form action="<?php echo e(route('about.add')); ?>" method="POST" data-parsley-validate=""
                            ...
                            <div class="row">
                                <div
                                    ...
                                    <div class="card Recent-Users">
                                        ...
                                        <div class="card-block px-0 py-3">
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" id="description" name="description" style="height: 150px;"
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" id="missiondescription" name="missiondescription" style="height: 150px;"
                                                        data-parsley-required="true" data-parsley-required-message="Please enter Description"
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" id="historydescription" name="historydescription"
                                                        style="height: 150px;" data-parsley-required="true" data-parsley-required-message="Please enter Description"
                                    ...
                                    <div class="card Recent-Users next-box">
                                        ...
                                        <div class="card-block px-0 py-3">
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="mv_description_1" id="mv_description_1" rows="5"
                                                        ...
                                                        <?php if(isset($mission_values->mv_icon_1) && $mission_values->mv_icon_1 != '' && $mission_values->mv_icon_1 != null): ?>
                                                            ...
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('uploads/' . $img->name)); ?>"
                                                                    ...
                                                                    class="profile-img">
                                                                <a id="mvicon1_banner_remove_image"> <i
                                                        ...
                                                        <?php else: ?>
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>"
                                                                    alt="" id="mvicon1_banner_avtar"
                                                                    class="profile-img">
                                                                <a id="mvicon1_banner_remove_image"
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="mv_description_2" id="mv_description_2" rows="5"
                                                        ...
                                                        <?php if(isset($mission_values->mv_icon_2) && $mission_values->mv_icon_2 != '' && $mission_values->mv_icon_2 != null): ?>
                                                            ...
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('uploads/' . $img->name)); ?>"
                                                                    ...
                                                                    class="profile-img">
                                                                <a id="mvicon2_banner_remove_image"> <i
                                                                        class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>"
                                                                    alt="" id="mvicon2_banner_avtar"
                                                                    class="profile-img">
                                                                <a id="mvicon2_banner_remove_image"
                                                                    style="display: none;"> <i class="fa fa-times"
                                                                        aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php endif; ?>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="mv_description_3" id="mv_description_3" rows="5"
                                                        ...
                                                        <?php if(isset($mission_values->mv_icon_3) && $mission_values->mv_icon_3 != '' && $mission_values->mv_icon_3 != null): ?>
                                                            ...
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('uploads/' . $img->name)); ?>"
                                                                    ...
                                                                    class="profile-img">
                                                                <a id="mvicon3_banner_remove_image"> <i
                                                                        class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>"
                                                                    alt="" id="mvicon3_banner_avtar"
                                                                    class="profile-img">
                                                                <a id="mvicon3_banner_remove_image"
                                                                    style="display: none;"> <i class="fa fa-times"
                                                                        aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php endif; ?>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="mv_description_4" id="mv_description_4" rows="5"
                                                        ...
                                                        <?php if(isset($mission_values->mv_icon_4) && $mission_values->mv_icon_4 != '' && $mission_values->mv_icon_4 != null): ?>
                                                            ...
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('uploads/' . $img->name)); ?>"
                                                                    ...
                                                                    class="profile-img">
                                                                <a id="mvicon4_banner_remove_image"> <i
                                                                        class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>"
                                                                    alt="" id="mvicon4_banner_avtar"
                                                                    class="profile-img">
                                                                <a id="mvicon4_banner_remove_image"
                                                                    style="display: none;"> <i class="fa fa-times"
                                                                        aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php endif; ?>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="mv_description_5" id="mv_description_5" rows="5"
                                                        ...
                                                        <?php if(isset($mission_values->mv_icon_5) && $mission_values->mv_icon_5 != '' && $mission_values->mv_icon_5 != null): ?>
                                                            ...
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('uploads/' . $img->name)); ?>"
                                                                    ...
                                                                    class="profile-img">
                                                                <a id="mvicon5_banner_remove_image"> <i
                                                                        class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>"
                                                                    alt="" id="mvicon5_banner_avtar"
                                                                    class="profile-img">
                                                                <a id="mvicon5_banner_remove_image"
                                                                    style="display: none;"> <i class="fa fa-times"
                                                                        aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php endif; ?>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="mv_description_6" id="mv_description_6" rows="5"
                                                        ...
                                                        <?php if(isset($mission_values->mv_icon_6) && $mission_values->mv_icon_6 != '' && $mission_values->mv_icon_6 != null): ?>
                                                            ...
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('uploads/' . $img->name)); ?>"
                                                                    ...
                                                                    class="profile-img">
                                                                <a id="mvicon6_banner_remove_image"> <i
                                                                        class="fa fa-times" aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php else: ?>
                                                            <div class="image_preview_div">
                                                                <img src="<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>"
                                                                    alt="" id="mvicon6_banner_avtar"
                                                                    class="profile-img">
                                                                <a id="mvicon6_banner_remove_image"
                                                                    style="display: none;"> <i class="fa fa-times"
                                                                        aria-hidden="true"></i></a>
                                                            </div>
                                                        <?php endif; ?>
                                    ...
                                    <div class="card Recent-Users next-box">
                                        ...
                                        <div class="card-block px-0 py-3">
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="our_history_desc" id="our_history_desc" rows="5"
                                    ...
                                    <div class="card Recent-Users next-box" <?php if(in_array(auth()->user()->role, ['dealer'])): ?> style="display:none" <?php endif; ?>>
                                        <h5>Meta Tags</h5>
                                        <div class="card-block px-0 py-3">
                                            <div class="row form-sec">
                                                <div
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" id="meta_description" name="meta_description" style="height: 150px;"
                                                        data-parsley-errors-container="#content_required1" data-parsley-required-message="Please Enter Description" placeholder="Meta Description"><?php echo e(isset($about->meta_description) ? $about->meta_description : ''); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row form-sec">
                                                <div
                                                    ...
                                                    <div class="upload-img-sec text-center image_preview_div">
                                                        ...
                                                        <?php endif; ?>
                                                        <label for="" style="cursor: pointer;"
                                                            class="choose_file hm-choose-img-title"  data-val="abt_mb_bannerimage">Choose image</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/clarkandsonsdoors.com/public_html/resources/views/about/index.blade.php ENDPATH**/ ?>