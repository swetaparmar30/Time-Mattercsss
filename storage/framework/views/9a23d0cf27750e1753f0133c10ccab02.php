...
<?php endif; ?>
<section class="pricavy-banner inner-service-banner">
  <img src="/uploads/privacy-policy-banner.webp" alt="" class="img-fluid w-100 banner-img resizable-image" width="1920" height="767" style="position: relative; display: inline-block;">
      ...
      <div class="container-md">
        <div class="row">
          <div class="banner-text">
            ...
            <p>
            At TimeMatters Inc., we are committed to protecting the privacy and confidentiality of the
                        personal information collected from our users. This Privacy Policy outlines how we collect, use,
                        store, and protect your personal information. By using our website and services, you agree to
...
<div class="time-matter without-padding-footer">
		<div class="container">
...
<?php echo $__env->make('frontend.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/hamzahk15.sg-host.com/public_html/resources/views/frontend/custom_page.blade.php ENDPATH**/ ?>