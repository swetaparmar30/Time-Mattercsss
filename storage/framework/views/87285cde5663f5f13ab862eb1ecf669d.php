    ...
    <picture>
        ...
        <img class="banner-img" src="<?php echo e($bannerImg1920x757); ?>" data-src="<?php echo e($bannerImg1920x757); ?>"
            ...
            sizes="(max-width: 575px) 575px, 
                    ...
                    1500px"
            alt="<?php echo e($bannerAltText); ?>" width="500" height="415" fetchpriority="high" loading="eager"
            decoding="async">
    </picture>
        ...
        <div class="container-md">
            <div class="row">
                ...
                <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12 left-side desk-banner-left-side">
                    ...
                    <img src="<?php echo e(asset('front-assets/src/images/mobile-banner-frame.webp')); ?>" class="img-fluid home-page-banner-mobile-layout-img">
                </div>
...
<?php /**PATH /home/customer/www/nateb61.sg-host.com/public_html/resources/views/frontend/includes/bannersection.blade.php ENDPATH**/ ?>