...
<section class="year-of-excilence sandk-common">
    ...
    <?php if(!empty($system_setting->title1)): ?>
        <?php
            $url1 = null;
        ...
        <li>
            <?php if($url1): ?>
                <img src="<?php echo e($url1); ?>" alt="<?php echo e(strip_tags($system_setting->title1)); ?>">
            <?php endif; ?>
            <span><?php echo $system_setting->title1; ?></span>
        </li>
    <?php endif; ?>

    <?php if(!empty($system_setting->title2)): ?>
        <?php
            $url2 = null;
        ...
        <li>
            <?php if($url2): ?>
                <img src="<?php echo e($url2); ?>" alt="<?php echo e(strip_tags($system_setting->title2)); ?>">
            <?php endif; ?>
            <span><?php echo $system_setting->title2; ?></span>
        </li>
    <?php endif; ?>

    <?php if(!empty($system_setting->title3)): ?>
        <?php
            $url3 = null;
        ...
        <li>
            <?php if($url3): ?>
                <img src="<?php echo e($url3); ?>" alt="<?php echo e(strip_tags($system_setting->title3)); ?>">
            <?php endif; ?>
            <span><?php echo $system_setting->title3; ?></span>
        </li>
    <?php endif; ?>

    <?php if(!empty($system_setting->title4)): ?>
        <?php
            $url4 = null;
        ...
        <li>
            <?php if($url4): ?>
                <img src="<?php echo e($url4); ?>" alt="<?php echo e(strip_tags($system_setting->title4)); ?>">
            <?php endif; ?>
            <span><?php echo $system_setting->title4; ?></span>
        </li>
    <?php endif; ?>
...
<?php /**PATH /home/customer/www/clarkandsonsdoors.com/public_html/resources/views/frontend/includes/systemsetting.blade.php ENDPATH**/ ?>