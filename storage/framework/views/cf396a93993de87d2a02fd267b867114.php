                            ...
                            <div class="row">
                                    ...
                                    <div class="card Recent-Users">
                                     ...
                                     <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                        <textarea class="form-control" id="map" name="map" style="height: 200px;"><?php echo e(isset($setting->map) ? $setting->map : ''); ?></textarea>
                                                ...
                                                <div class="row form-sec" <?php if(in_array(auth()->user()->role, ['dealer'])): ?> style="display:none" <?php endif; ?>>
                                                    <div
                                                        class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 label-sec">
                                    ...
                                    <div class="card Recent-Users next-box">
                                        ...
                                        <div class="card-block px-0 py-3">
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="sun_form" id="sun_form"
                                                        placeholder="From"
                                                        value="<?php echo e(isset($s_json->from) ? $s_json->from : ''); ?>">
                                                </div>
                                                <div class="col-xxl-3 col-xl-3 col-lg-2 col-md-3 col-sm-12 col-xs-12">
                                                    <input type="time" name="sun_to" id="sun_to"
                                                        placeholder="To"
                                                        value="<?php echo e(isset($s_json->to) ? $s_json->to : ''); ?>">
                                                </div>
                                ...
                                <div
                                    class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 cpl-sm-12 col-xs-12 add-article form-main-sec right-sec">
                                        ...
                                        <div class="card Recent-Users next-box" style="margin-top: 0 !important;" <?php if(in_array(auth()->user()->role, ['dealer', 'marketing'])): ?> style="display:none" <?php endif; ?>>
                                            <h5>Site Logo</h5>
                                            <div class="card-block px-0 py-3">
                                                <div class="row form-sec">
                                                    <div
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admin-laravel\resources\views/settings/index.blade.php ENDPATH**/ ?>