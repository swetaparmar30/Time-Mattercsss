            ...
            <ul class="nav pcoded-inner-navbar">
                ...
                <?php else: ?>
                    ...
                    <li data-username="dashboard"
                     ...
                     <li data-username="dashboard"
                        class="nav-item <?php echo e(\Request::route()->getName() == 'centralfile.index' || \Request::route()->getName() == 'centralfile.add' || \Request::route()->getName() == 'centralfile.edit' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('centralfile.index')); ?>" class="nav-link "><span class="pcoded-micon"><i
...
<?php /**PATH /home/customer/www/hamzahk15.sg-host.com/public_html/resources/views/layouts/backend/sidebar.blade.php ENDPATH**/ ?>