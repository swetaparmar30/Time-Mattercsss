        ...
        <div class="container-md">
            <div class="row">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 service-link">
                    <h3>Services</h3>
                    <ul>
                        <li><a href="">Vendor Management Solutions</a></li>
                        <li><a href="">Qualified Resources on Demand</a></li>
                        <li><a href="">Payrolling and Independent Contractor Management</a></li>
                        <li><a href="">Vendor Management Solutions Advisory</a></li>
                    </ul>
                </div>
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-12 col-12 member-access">
                    ...
                    <ul>
                        ...
                        <li><a href="">Temporary Employee</a></li>
                ...
                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-12 col-12  contact-link">
                    ...
                    <div class="icon-sec">
                        <img src="<?php echo e(asset('front-assets/src/images/linkdin-circle-icon.webp' )); ?>" alt="" width="44" height="44" class="img-fluid">
                        <img src="<?php echo e(asset('front-assets/src/images/location-circle-icon.webp' )); ?>" alt="" width="44" height="44"
                            class="img-fluid">
    ...
    <section class="copy-right-sec">
        <div class="container-md">
            <div class="row">
                <p>© 2026 TimeMatters Inc. <span>|</span><a href="">Sitemap</a><span>|</span> <a href="">Privacy
                        Policy</a></p>
            </div>
        </div>
    </section>
<?php /**PATH C:\wamp64\www\Time\9-april\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>