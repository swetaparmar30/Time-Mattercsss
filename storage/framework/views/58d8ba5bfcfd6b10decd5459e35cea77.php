...
<div class="pcoded-wrapper">
                            ...
                            <div class="card Recent-Users mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                                        <form id="addcategory" action="<?php echo e(route('categories.save')); ?>" method="POST"
    ...
    $(document).on('change', '#name', function(e) {
        ...
        var val = $(this).val();
        $.ajax({
            url: "<?php echo e(route('category.check_slug')); ?>",
            method: "POST",
            data: {
                _token: token,
                name: val
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/hamzahk15.sg-host.com/public_html/resources/views/categories/index.blade.php ENDPATH**/ ?>