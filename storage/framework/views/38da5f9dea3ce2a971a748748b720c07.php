            ...
            <div class="row form-sec">
                <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                    ...
                    <div class="label-sec">
                        ...
                        <textarea class="notes" type="text" name="note1" id="note1" placeholder="Title" data-parsley-required-message="Please Enter Notes" value="<?php echo e(isset($system_setting->note1) ? $system_setting->note1 : ''); ?>" style="height: 100px;"><?php echo e(isset($system_setting->note1) ? $system_setting->note1 : ''); ?></textarea>
                    </div>
                    <div class="label-sec">
                         <label for="">Button Name</label>
                         <input type="text" name="btn_name1" id="btn_name1" placeholder="Button Name" value="<?php echo e(isset($system_setting->btn_name1) ? $system_setting->btn_name1 : ''); ?>">
                    </div>
                    <div class="label-sec">
                         <label for="">Button Url</label>
                         <input type="text" name="btn_url1" id="btn_url1" placeholder="Button Url"  value="<?php echo e(isset($system_setting->btn_url1) ? $system_setting->btn_url1 : ''); ?>">
                    </div>
                </div>
            ...
            <div class="row form-sec">
                <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                    ...
                    <div class="label-sec">
                        ...
                        <textarea class="notes" type="text" name="note2" id="note2" placeholder="Title" data-parsley-required-message="Please Enter Notes" value="<?php echo e(isset($system_setting->note2) ? $system_setting->note2 : ''); ?>" style="height: 100px;"><?php echo e(isset($system_setting->note2) ? $system_setting->note2 : ''); ?></textarea>
                    </div>
                    <div class="label-sec">
                         <label for="">Button Name</label>
                         <input type="text" name="btn_name2" id="btn_name2" placeholder="Button Name" value="<?php echo e(isset($system_setting->btn_name2) ? $system_setting->btn_name2 : ''); ?>">
                    </div>
                    <div class="label-sec">
                         <label for="">Button Url</label>
                         <input type="text" name="btn_url2" id="btn_url2" placeholder="Button Url" value="<?php echo e(isset($system_setting->btn_url2) ? $system_setting->btn_url2 : ''); ?>">
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <div class="row form-sec">
                <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                    ...
                    <div class="label-sec">
                        ...
                        <textarea class="notes" type="text" name="note3" id="note3" placeholder="Notes" value="<?php echo e(isset($system_setting->note3) ? $system_setting->note3 : ''); ?>" style="height: 100px;"><?php echo e(isset($system_setting->note3) ? $system_setting->note3 : ''); ?></textarea>
                    </div>
                    <div class="label-sec">
                         <label for="">Button Name</label>
                         <input type="text" name="btn_name3" id="btn_name3" placeholder="Button Name" value="<?php echo e(isset($system_setting->btn_name3) ? $system_setting->btn_name3 : ''); ?>">
                    </div>
                    <div class="label-sec">
                         <label for="">Button Url</label>
                         <input type="text" name="btn_url3" id="btn_url3" placeholder="Button Url" value="<?php echo e(isset($system_setting->btn_url3) ? $system_setting->btn_url3 : ''); ?>">
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
            ...
            <div class="row form-sec">
                <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 label-sec">
                    ...
                    <div class="label-sec">
                        ...
                        <textarea class="notes" type="text" name="note4" id="note4" placeholder="Title" data-parsley-required-message="Please Enter Notes" value="<?php echo e(isset($system_setting->note4) ? $system_setting->note4 : ''); ?>" style="height: 100px;"><?php echo e(isset($system_setting->note4) ? $system_setting->note4 : ''); ?></textarea>
                    </div>
                    <div class="label-sec">
                         <label for="">Button Name</label>
                         <input type="text" name="btn_name4" id="btn_name4" placeholder="Title" data-parsley-required-message="Please Enter Button Name" value="<?php echo e(isset($system_setting->btn_name4) ? $system_setting->btn_name4 : ''); ?>">
                    </div>
                    <div class="label-sec">
                         <label for="">Button Url</label>
                         <input type="text" name="btn_url4" id="btn_url4" placeholder="Title" data-parsley-required-message="Please Enter Button Url" value="<?php echo e(isset($system_setting->btn_url4) ? $system_setting->btn_url4 : ''); ?>">
                    </div>
                </div>
                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
...
<?php /**PATH /home/customer/www/hamzahk15.sg-host.com/public_html/resources/views/settings/system_setting_sec.blade.php ENDPATH**/ ?>