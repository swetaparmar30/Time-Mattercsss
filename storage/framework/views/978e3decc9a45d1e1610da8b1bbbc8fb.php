            ...
            <div class="main-body">
                <div class="page-wrapper">
                    <form action="<?php echo e(route('loadingdock.add')); ?>" method="POST" data-parsley-validate=""
                        ...
                        <?php echo csrf_field(); ?>
                        <?php if(isset($loadingdockdoor)): ?>
                        <input type="hidden" name="loadingdockdoor_id"
                            value="<?php echo e(isset($loadingdockdoor->id) ? $loadingdockdoor->id : ''); ?>">
                        <?php endif; ?>
                        <div class="row">
                            <div
                                        ...
                                        <div class="row form-sec">
                                            <div
                                                ...
                                                <input type="hidden" name="title"
                                                    value="<?php echo e(isset($loadingdockdoor->title) ? $loadingdockdoor->title : ''); ?>">
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor" id="description"
                                                    name="description"><?php echo e(isset($loadingdockdoor->description) ? $loadingdockdoor->description : ''); ?></textarea>
                                            ...
                                            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                <div class="upload-img-sec">
                                                    <input type="hidden" name="bannerimage" id="bannerimage"
                                                        value="<?php echo e(isset($loadingdockdoor->bannerimage) ? $loadingdockdoor->bannerimage : ''); ?>">
                                                    <?php if(isset($loadingdockdoor->bannerimage) &&
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <input type="text" name="c_s_button_name" id="c_s_button_name"
                                                    ...
                                                    value="<?php echo e(isset($loadingdockdoor->c_s_button_name) ? $loadingdockdoor->c_s_button_name : ''); ?>"
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <input type="text" name="c_s_button_url" id="c_s_button_url"
                                                    ...
                                                    value="<?php echo e(isset($loadingdockdoor->c_s_button_url) ? $loadingdockdoor->c_s_button_url : ''); ?>"
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" id="section2_description"
                                                        name="section2_description"><?php echo e(isset($section2->section2_description) ? $section2->section2_description : ''); ?></textarea>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="sec2_description_1" id="sec2_description_1" rows="5"
                                                        cols="10"><?php echo e(isset($section2->sec2_description_1) ? $section2->sec2_description_1 : ''); ?></textarea>
                                                </div>
                                                ...
                                                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                    <div class="upload-img-sec">
                                                        ...
                                                        <?php if(isset($section2->sec2_image_1) && $section2->sec2_image_1
                                                        != ''
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="sec2_description_2" id="sec2_description_2" rows="5"
                                                        cols="10"><?php echo e(isset($section2->sec2_description_2) ? $section2->sec2_description_2 : ''); ?></textarea>
                                                </div>
                                                ...
                                                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                    <div class="upload-img-sec">
                                                        ...
                                                        <?php if(isset($section2->sec2_image_2) && $section2->sec2_image_2
                                                        != ''
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="sec2_description_3" id="sec2_description_3" rows="5"
                                                        cols="10"><?php echo e(isset($section2->sec2_description_3) ? $section2->sec2_description_3 : ''); ?></textarea>
                                                </div>
                                                ...
                                                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                    <div class="upload-img-sec">
                                                        ...
                                                        <?php if(isset($section2->sec2_image_3) && $section2->sec2_image_3
                                                        != ''
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="sec2_description_4" id="sec2_description_4" rows="5"
                                                        cols="10"><?php echo e(isset($section2->sec2_description_4) ? $section2->sec2_description_4 : ''); ?></textarea>
                                                </div>
                                                ...
                                                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                    <div class="upload-img-sec">
                                                        ...
                                                        <?php if(isset($section2->sec2_image_4) && $section2->sec2_image_4
                                                        != ''
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="sec3_description_1" id="sec3_description_1" rows="5"
                                                        cols="10"><?php echo e(isset($section3->sec3_description_1) ? $section3->sec3_description_1 : ''); ?></textarea>
                                                </div>
                                                ...
                                                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                    <div class="upload-img-sec">
                                                        ...
                                                        <?php if(isset($section3->sec3_image_1) && $section3->sec3_image_1
                                                        != ''
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="sec3_description_2" id="sec3_description_2" rows="5"
                                                        cols="10"><?php echo e(isset($section3->sec3_description_2) ? $section3->sec3_description_2 : ''); ?></textarea>
                                                </div>
                                                ...
                                                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                    <div class="upload-img-sec">
                                                        ...
                                                        <?php if(isset($section3->sec3_image_2) && $section3->sec3_image_2
                                                        != ''
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="sec3_description_3" id="sec3_description_3" rows="5"
                                                        cols="10"><?php echo e(isset($section3->sec3_description_3) ? $section3->sec3_description_3 : ''); ?></textarea>
                                                </div>
                                                ...
                                                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                    <div class="upload-img-sec">
                                                        ...
                                                        <?php if(isset($section3->sec3_image_3) && $section3->sec3_image_3
                                                        != ''
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="sec3_description_4" id="sec3_description_4" rows="5"
                                                        cols="10"><?php echo e(isset($section3->sec3_description_4) ? $section3->sec3_description_4 : ''); ?></textarea>
                                                </div>
                                                ...
                                                <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                    <div class="upload-img-sec">
                                                        ...
                                                        <?php if(isset($section3->sec3_image_4) && $section3->sec3_image_4
                                                        != ''
                                        ...
                                        <div class="row form-sec">
                                            <div
                                                ...
                                                <input type="hidden" name="section4_sub_title"
                                                    value="<?php echo e(isset($section4->section4_sub_title) ? $section4->section4_sub_title : ''); ?>">
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor" id="section4_description"
                                                    name="section4_description"><?php echo e(isset($section4->section4_description) ? $section4->section4_description : ''); ?></textarea>
                                            ...
                                            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                <div class="upload-img-sec">
                                                    ...
                                                    <?php if(isset($section4->section4_image) && $section4->section4_image
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor" id="section5_description"
                                                    name="section5_description"><?php echo e(isset($section5->section5_description) ? $section5->section5_description : ''); ?></textarea>
                                                ...
                                                <div class="row form-sec">
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="text" name="meta_title" id="meta_title"
                                                            placeholder="Title"
                                                            value="<?php echo e(isset($loadingdockdoor->meta_title) ? $loadingdockdoor->meta_title : ''); ?>"
                                                            data-parsley-required-message="Please Enter Title">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row form-sec">
                                                    ...
                                                    <div
                                                        ...
                                                        <input type="text" name="meta_keyword" id="meta_keyword"
                                                            placeholder="Sub Title"
                                                            value="<?php echo e(isset($loadingdockdoor->meta_keyword) ? $loadingdockdoor->meta_keyword : ''); ?>"
                                                ...
                                                <div class="row form-sec">
                                                    ...
                                                    <div
                                                        ...
                                                        <textarea class="form-control"  id="meta_description"
                                                            ...
                                                            data-parsley-required-message="Please Enter Description"><?php echo e(isset($loadingdockdoor->meta_description) ? $loadingdockdoor->meta_description : ''); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/hamzahk15.sg-host.com/public_html/resources/views/loadingdock/index.blade.php ENDPATH**/ ?>