<?php $__env->startSection('title'); ?> <?php echo e(isset($meta_title) ? $meta_title : 'TimeMatters Inc.'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('description'); ?> <?php echo e(isset($meta_description) ? $meta_description : 'TimeMatters Inc.'); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('keywords'); ?> <?php echo e(isset($meta_keywords) ? $meta_keywords : 'TimeMatters Inc.'); ?> <?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="container-md">
                    <div class="row">
                        <div class="banner-text">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(isset($service->section1_button_url) ? $service->section1_button_url : 'https://hamzahk15.sg-host.com/contact/'); ?>"
    ...
    <section class="vendore-mange-info-sec time-matter-common time-matter-common-padding service-<?php echo e($service->id); ?>"
        id="service-<?php echo e($service->id); ?>">
        <div class="container-md">
            <div class="row">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12  left-side">
                    <?php if(isset($service->section2_title)): ?>
                        <h2 class="desktop-heading mrbt-20"><?php echo $service->section2_title; ?></h2>
                        <h2 class="mobile-heading mrbt-20"><?php echo $service->section2_title; ?></h2>
                    <?php endif; ?>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 right-side">
                    <?php if(isset($service->section2_title2)): ?>
                        <h2 class="mrbt-20"><?php echo $service->section2_title2; ?></h2>
                    <?php endif; ?>
    ...
    <?php if(in_array($service->id, [5, 6])): ?>

        <section class="culture-values-sec why-choose-sec time-matter-common time-matter-common-padding extre-service-section service-<?php echo e($service->id); ?>">
            <div class="container-md">
                <div class="row first-row">
                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 top-heading text-center ">
                        <?php if(isset($service->historysubtitle) && $service->historysubtitle != null): ?>
                            <h2 class="mrbt-20"><?php echo e($service->historysubtitle); ?></h2>
                        <?php endif; ?>
                        ...
                        <?php if(isset($service->historydescription) && $service->historydescription != null): ?>
                            <?php echo $service->historydescription; ?>
                ...
                <div class="row align-items-center second-row">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 image-side">
                        ...
                        <?php if(!empty($service->historyimage)): ?>
                            <?php
                            ...
                            <?php if(!empty($h_img->name)): ?>
                                <img src="<?php echo e(asset('uploads/' . $h_img->name)); ?>" alt="<?php echo e($h_img->alt_text); ?>"
                                    class="img-fluid desktop-img">
                            <?php else: ?>
                                <img src="<?php echo e(asset('front-assets/src/images/culture-values-img.webp')); ?>" alt=""
                                    class="img-fluid desktop-img">
                            <?php endif; ?>
                        <?php else: ?>
                            <img src="<?php echo e(asset('front-assets/src/images/culture-values-img.webp')); ?>" alt=""
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 right-side">
                        ...
                        <?php if(isset($service->cv_subtitle_1) && $service->cv_subtitle_1 != null): ?>
                            <article>
                                <div class="content">
                                    <h3><?php echo e($service->cv_subtitle_1); ?></h3>
                                    <?php if(isset($service->cv_note_1) && $service->cv_note_1 != null): ?>
                                        <p><?php echo e($service->cv_note_1); ?></p>
                                    <?php endif; ?>
                                </div>
                            </article>
                        <?php endif; ?>
                        <?php if(isset($service->cv_subtitle_2) && $service->cv_subtitle_2 != null): ?>
                            <article>
                                <div class="content">
                                    <h3><?php echo e($service->cv_subtitle_2); ?></h3>
                                    <?php if(isset($service->cv_note_2) && $service->cv_note_2 != null): ?>
                                        <p><?php echo e($service->cv_note_2); ?></p>
                                    <?php endif; ?>
                                </div>
                            </article>
                        <?php endif; ?>
                        <?php if(isset($service->cv_subtitle_3) && $service->cv_subtitle_3 != null): ?>
                            <article>
                                <div class="content">
                                    <h3><?php echo e($service->cv_subtitle_3); ?></h3>
                                    <?php if(isset($service->cv_note_3) && $service->cv_note_3 != null): ?>
                                        <p><?php echo e($service->cv_note_3); ?></p>
                                    <?php endif; ?>
                                </div>
                            </article>
                        <?php endif; ?>
                        <?php if(isset($service->cv_subtitle_4) && $service->cv_subtitle_4 != null): ?>
                            <article>
                                <div class="content">
                                    <h3><?php echo e($service->cv_subtitle_4); ?></h3>
                                    <?php if(isset($service->cv_note_4) && $service->cv_note_4 != null): ?>
                                        <p><?php echo e($service->cv_note_4); ?></p>
                                    <?php endif; ?>
                                </div>
                            </article>
                        <?php endif; ?>
                        <?php if(isset($service->cv_subtitle_5) && $service->cv_subtitle_5 != null): ?>
                            <article>
                                <div class="content">
                                    <h3><?php echo e($service->cv_subtitle_5); ?></h3>
                                    <?php if(isset($service->cv_note_5) && $service->cv_note_5 != null): ?>
                                        <p><?php echo e($service->cv_note_5); ?></p>
                                    <?php endif; ?>
                                </div>
                            </article>
                        <?php endif; ?>
    ...
    <?php else: ?>
        ...
        <section class="how-vendor-mage-sec time-matter-common service-<?php echo e($service->id); ?>">
            <div class="container-md">
                <div class="row">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 left-side">
    ...
    <?php if(isset($service->section4_title) && $service->section4_title != null): ?>
    <section class="benefits-vendor-sec  time-matter-common time-matter-common-padding benefits-service-cmn-sec service-<?php echo e($service->id); ?>">
        <div class="container-md">
            <div class="row">
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 top-heading text-center">
            ...
            <div class="row second-row">
                ...
                <div class="col-xxl-10 col-xl-10 col-lg-11 col-md-12 col-sm-12 col-12 two-side-line-sec">
                    <?php if(isset($service->section4_subtitle1) && !empty($service->section4_subtitle1)): ?>
                        <article>
                    ...
                    <?php endif; ?>
                    <?php if(isset($service->section4_subtitle2) && !empty($service->section4_subtitle2)): ?>
                        <article>
                    ...
                    <?php endif; ?>
                    <?php if(isset($service->section4_subtitle3) && !empty($service->section4_subtitle3)): ?>
                        <article>
                    ...
                    <?php endif; ?>
                    <?php if(isset($service->section4_subtitle4) && !empty($service->section4_subtitle4)): ?>
                        <article>
                    ...
                    <?php endif; ?>
                    <?php if(isset($service->section4_subtitle5) && !empty($service->section4_subtitle5)): ?>
                        <article>
                    ...
                    <?php endif; ?>
                    <?php if(isset($service->section4_subtitle6) && !empty($service->section4_subtitle6)): ?>
                        <article>
    ...
    <section class="blue-oragnization-work-box  time-matter-common time-matter-common-padding service-<?php echo e($service->id); ?>">
        <div class="container-md">
    ...
    <?php if($service->slug != 'vendor-management-solution'): ?>
        ...
        <section class="after-bluebox-cta-sec  time-matter-common time-matter-common-padding ">
            <div class="container-md">
                <div class="row justify-content-center">
                    <div class="col-xxl-10 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 blue-box text-center">
                        <?php if(isset($service->expert_title) && $service->expert_title != null): ?>
                            <h2 class="mrbt-20"><?php echo e($service->expert_title); ?></h2>
                        <?php endif; ?>
                        <?php if(isset($service->expert_description)): ?>
                            <?php echo $service->expert_description; ?>

                        <?php endif; ?>
                        <?php if(isset($service->expert_button_name)): ?>
                            <a href="<?php echo e(!empty($service->expert_url) ? $service->expert_url : '#'); ?>" class="cmn-btn mx-auto">
                                <?php echo e(!empty($service->expert_button_name) ? $service->expert_button_name : 'Schedule a Consultation'); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/hamzahk15.sg-host.com/public_html/resources/views/frontend/service/vendor-management-solutions.blade.php ENDPATH**/ ?>