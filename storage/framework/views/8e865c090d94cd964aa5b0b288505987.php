                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <button class="blue-common-btn g-recaptcha" data-sitekey="<?php echo e(config('services.recaptcha.site_key')); ?>" data-callback='onSubmit' data-action='submit' style="display: none;">Send Message</button>
                                 <button type="submit" class="submit_form">Get a Free Quote</button>
                            </div>
                        </div>
                    </div>
...
</footer><?php /**PATH /home/customer/www/hamzahk13.sg-host.com/public_html/resources/views/frontend/layouts/footer.blade.php ENDPATH**/ ?>