                        ...
                        <form action="<?php echo e(route('about.add')); ?>" method="POST" data-parsley-validate=""
                            ...
                            <div class="row">
                                <div
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" id="description"
                                                        ...
                                                        data-parsley-errors-container="#description_required"><?php echo e(isset($about->description) ? $about->description : ''); ?></textarea>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="how_we_deliver_title" id=""
                                                        ...
                                                        value="<?php echo e(isset($about->how_we_deliver_title) ? $about->how_we_deliver_title : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor"
                                                        ...
                                                        cols="10"><?php echo e(isset($about->how_we_deliver_desc) ? $about->how_we_deliver_desc : ''); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="hwd_img_note" id="hwd_img_note"
                                                        ...
                                                        cols="10"><?php echo e(isset($about->hwd_img_note) ? $about->hwd_img_note : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="hwd_subtitle_1" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->hwd_subtitle_1) ? $about->hwd_subtitle_1 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="hwd_note_1" id="hwd_note_1"
                                                        rows="2" style="height:80px"
                                                        cols="10"><?php echo e(isset($about->hwd_note_1) ? $about->hwd_note_1 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="hwd_subtitle_2" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->hwd_subtitle_2) ? $about->hwd_subtitle_2 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="hwd_note_2" id="hwd_note_2"
                                                        rows="2" style="height:80px"
                                                        cols="10"><?php echo e(isset($about->hwd_note_2) ? $about->hwd_note_2 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="hwd_subtitle_3" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->hwd_subtitle_3) ? $about->hwd_subtitle_3 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="hwd_note_3" id="hwd_note_3"
                                                        rows="2" style="height:80px"
                                                        cols="10"><?php echo e(isset($about->hwd_note_3) ? $about->hwd_note_3 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="hwd_subtitle_4" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->hwd_subtitle_4) ? $about->hwd_subtitle_4 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="hwd_note_4" id="hwd_note_4"
                                                        rows="2" style="height:80px"
                                                        cols="10"><?php echo e(isset($about->hwd_note_4) ? $about->hwd_note_4 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="cv_img_note" id="cv_img_note"
                                                        rows="2" style="height:80px"
                                                        cols="10"><?php echo e(isset($about->cv_img_note) ? $about->cv_img_note : ''); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="cv_subtitle_1" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->cv_subtitle_1) ? $about->cv_subtitle_1 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="cv_note_1" id="cv_note_1" rows="2"
                                                        style="height:80px"
                                                        cols="10"><?php echo e(isset($about->cv_note_1) ? $about->cv_note_1 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="cv_subtitle_2" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->cv_subtitle_2) ? $about->cv_subtitle_2 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="cv_note_2" id="cv_note_2" rows="2"
                                                        style="height:80px"
                                                        cols="10"><?php echo e(isset($about->cv_note_2) ? $about->cv_note_2 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="cv_subtitle_3" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->cv_subtitle_3) ? $about->cv_subtitle_3 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="cv_note_3" id="cv_note_3" rows="2"
                                                        style="height:80px"
                                                        cols="10"><?php echo e(isset($about->cv_note_3) ? $about->cv_note_3 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="cv_subtitle_4" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->cv_subtitle_4) ? $about->cv_subtitle_4 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="cv_note_4" id="cv_note_4" rows="2"
                                                        style="height:80px"
                                                        cols="10"><?php echo e(isset($about->cv_note_4) ? $about->cv_note_4 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="cv_subtitle_5" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->cv_subtitle_5) ? $about->cv_subtitle_5 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="cv_note_5" id="cv_note_5" rows="2"
                                                        style="height:80px"
                                                        cols="10"><?php echo e(isset($about->cv_note_5) ? $about->cv_note_5 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="el_title" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->el_title) ? $about->el_title : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="mv_post_1" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($mission_values->mv_post_1) ? $mission_values->mv_post_1 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="mv_description_1"
                                                        ...
                                                        cols="10"><?php echo e(isset($mission_values->mv_description_1) ? $mission_values->mv_description_1 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="mv_post_2" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($mission_values->mv_post_2) ? $mission_values->mv_post_2 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="mv_description_2"
                                                        ...
                                                        cols="10"><?php echo e(isset($mission_values->mv_description_2) ? $mission_values->mv_description_2 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                                                                    ...
                                                                                                    <div class="row form-sec">
                                                                                                        ...
                                                                                                        <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                                                                            <textarea class="form-control rich-text-editor" name="mv_description_3"
                                                                                                                ...
                                                                                                                cols="10"><?php echo e(isset($mission_values->mv_description_3) ? $mission_values->mv_description_3 : ''); ?></textarea>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="row form-sec">
                                                                                                        <div
                                                                                                    ...
                                                                                                    <div class="row form-sec">
                                                                                                        ...
                                                                                                        <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                                                                            <textarea class="form-control rich-text-editor" name="mv_description_4"
                                                                                                                ...
                                                                                                                cols="10"><?php echo e(isset($mission_values->mv_description_4) ? $mission_values->mv_description_4 : ''); ?></textarea>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="row form-sec">
                                                                                                        <div
                                                                                                    ...
                                                                                                    <div class="row form-sec">
                                                                                                        ...
                                                                                                        <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                                                                            <textarea class="form-control rich-text-editor" name="mv_description_5"
                                                                                                                ...
                                                                                                                cols="10"><?php echo e(isset($mission_values->mv_description_5) ? $mission_values->mv_description_5 : ''); ?></textarea>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="row form-sec">
                                                                                                        <div
                                                                                                    ...
                                                                                                    <div class="row form-sec">
                                                                                                        ...
                                                                                                        <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                                                                            <textarea class="form-control rich-text-editor" name="mv_description_6"
                                                                                                                ...
                                                                                                                cols="10"><?php echo e(isset($mission_values->mv_description_6) ? $mission_values->mv_description_6 : ''); ?></textarea>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div class="row form-sec">
                                                                                                        <div
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="our_history_desc"
                                                        ...
                                                        cols="10"><?php echo e(isset($about->our_history_desc) ? $about->our_history_desc : ''); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="os_subtitle_1" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->os_subtitle_1) ? $about->os_subtitle_1 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="os_note_1" id="os_note_1" rows="2"
                                                        style="height:80px"
                                                        cols="10"><?php echo e(isset($about->os_note_1) ? $about->os_note_1 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="os_subtitle_2" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->os_subtitle_2) ? $about->os_subtitle_2 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="os_note_2" id="os_note_2" rows="2"
                                                        style="height:80px"
                                                        cols="10"><?php echo e(isset($about->os_note_2) ? $about->os_note_2 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="os_subtitle_3" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->os_subtitle_3) ? $about->os_subtitle_3 : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" name="os_note_3" id="os_note_3" rows="2"
                                                        style="height:80px"
                                                        cols="10"><?php echo e(isset($about->os_note_3) ? $about->os_note_3 : ''); ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="why_title" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->why_title) ? $about->why_title : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control rich-text-editor" name="why_desc"
                                                        id="why_desc" rows="5"
                                                        cols="10"><?php echo e(isset($about->why_desc) ? $about->why_desc : ''); ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="why_button_name" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->why_button_name) ? $about->why_button_name : ''); ?>">
                                                </div>
                                            </div>
                                            <div class="row form-sec">
                                                <div
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <input type="text" name="why_button_url" id="" placeholder="Type here"
                                                        value="<?php echo e(isset($about->why_button_url) ? $about->why_button_url : ''); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card Recent-Users next-box" <?php if(in_array(auth()->user()->role, ['dealer'])): ?>
                                            ...
                                            <div class="row form-sec">
                                                ...
                                                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                                    <textarea class="form-control" id="meta_description"
                                                        ...
                                                        data-parsley-required-message="Please Enter Description"
                                                        placeholder="Meta Description"><?php echo e(isset($about->meta_description) ? $about->meta_description : ''); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="upload-img-sec text-center image_preview_div">
                                                        <input type="hidden" name="abt_mb_bannerimage"
                                                            ...
                                                            value="<?php echo e(isset($about->abt_mb_bannerimage) ? $about->abt_mb_bannerimage : ''); ?>">
                                                        <?php if(isset($about->abt_mb_bannerimage) && $about->abt_mb_bannerimage != '' && $about->abt_mb_bannerimage != null): ?>
                                                            <?php
                                                                $img = App\Models\MediaImage::select('name')
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/hamzahk15.sg-host.com/public_html/resources/views/about/index.blade.php ENDPATH**/ ?>