    ...
    <div class="container-fluid" style="background-color: #002855;">
        <div style="display: flex; justify-content: center;padding-top: 55px;">
            <div style="background-color: #e3e3e3;text-align: center;padding: 20px 0 0px 0;width:80%;margin: 0 auto;">
                <img src="<?php echo e(asset('front-assets/src/images/time-matters-logo.png')); ?>" style="background:transparent;" width="200" height="auto">
            </div>
        </div>
    </div>
    ...
    <div style="display: flex; justify-content: center;">
        <table width="100%" border="1" cellpadding="10px" cellspacing="0" style="text-align: left;width: 80%;border: 1px solid #f1f1f1;margin: 0 auto;">
            ...
            <tr>
                ...
                <td><label style="font-size: 15px;font-weight: 700;color: #000;margin:0 !important;">Company Name: </label> <?php echo e(isset($user_data['company']) ? $user_data['company'] : '-'); ?></td>
            </tr>
            <tr>
...
<?php /**PATH /home/customer/www/hamzahk15.sg-host.com/public_html/resources/views/emails/meetingMail.blade.php ENDPATH**/ ?>