...
<head>
    ...
    <meta name="description" content="Time Master Garage Doors">
    <meta name="author" content="Time Master Garage Doors">
    <meta name="keyword" content="Time Master Garage Doors">
    ...
    <!-- <link href="<?php echo e(asset('css/jquery.toastr.min.css')); ?>" type="text/css" rel="stylesheet"> -->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/dropzone/dropzone.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('assets/plugins/chart-morris/css/morris.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset("assets/css/plugins/rich-text-editor.css")); ?>" id="main-style-link">
...
<body>
    ...
    <div class="pcoded-main-container">
        ...
        <?php echo $__env->make('layouts.backend.mediamodal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <div>
            ...
            <script src="<?php echo e(asset('js/sweetalert/sweetalert2.all.min.js')); ?>"></script>
            ...
            <script src="<?php echo e(asset('vendors/chart.js/js/chart.min.js')); ?>"></script>
            <script src="<?php echo e(asset('vendors/@coreui/chartjs/js/coreui-chartjs.js')); ?>"></script>
            <script src="<?php echo e(asset('vendors/@coreui/utils/js/coreui-utils.js')); ?>"></script>
            ...
            <!-- <script src="<?php echo e(asset('assets/inputMask/bootstrap_input_mask.min.js')); ?>"></script> -->

            <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-maskmoney/3.0.2/jquery.maskMoney.min.js"></script>


            <script src="<?php echo e(asset("assets/js/plugins/rich-text-editor.js")); ?>"></script>
            ...
            <script>
                window.assetPath = "<?php echo e(asset('assets/images/user/img-demo_1041.jpg')); ?>";
            </script>
            <script>
                $(document).ready(function() {
                    ...
                    function loadImages(start) {
                        ...
                        $.ajax({
                            method: 'POST',
                            url: '<?php echo e(route('media.filter')); ?>',
                            data: {
                                start: start,
                            },
  ...
  <div class="dz-size" data-dz-size></div>
            ...
            <script>
                ...
                $(document).on("click", ".get_img_id", function() {
                    ...
                    if (['service_img', 'service_img_2', 'service_img_3', 'service_img_4', 'service_img_5', 'service_img_6']
                        .includes(type_id)) {
                        var service_sec = true;
                    }
                    $.ajax({
                        method: 'POST',
                        url: '<?php echo e(route('media.getimg.byid')); ?>',
                        data: {
                            // _token: token,
                            img_id: img_id
                        },
                        ...
                        success: function(response) {
                            ...
                            if (favicon) {
                                ...
                                let suffix = type_id.replace('service_img', '');
                                $('#service_img' + suffix).val(details.id);
                                $('#service_preview' + suffix).attr('src', imageUrl);
                                $('#service_remove_image' + suffix).css('display', 'block');
            ...
            <script src="<?php echo e(asset('js/passwordcdn/cdnjs.cloudflare.com_ajax_libs_zxcvbn_4.4.2_zxcvbn.js')); ?>"></script>
            <script src="<?php echo e(asset('assets/plugins/chart-morris/js/raphael.min.js')); ?>"></script>
            <script src="<?php echo e(asset('assets/plugins/chart-morris/js/morris.min.js')); ?>"></script>
            <script src="<?php echo e(asset('assets/plugins/jquery-ui/js/jquery-ui.js')); ?>"></script>
...
<?php /**PATH /home/customer/www/hamzahk13.sg-host.com/public_html/resources/views/layouts/backend/index.blade.php ENDPATH**/ ?>