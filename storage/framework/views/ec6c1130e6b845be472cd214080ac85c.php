                        ...
                        <?php if(isset($setting->contact_no)): ?>
                            <article>
                                ...
                                <div class="info">
                                    ...
                                    <p><a href="tel:<?php echo e($tel); ?>">+1 <?php echo e($setting->contact_no); ?></a></p>
                                </div>
                            </article>
                        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/hamzahk15.sg-host.com/public_html/resources/views/frontend/contact.blade.php ENDPATH**/ ?>