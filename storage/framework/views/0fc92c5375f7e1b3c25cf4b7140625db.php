                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-3 second-box-left">
                                            <div class="card-body nav-sidebar">
                                                <div class="list-group">
                                                    <?php $__currentLoopData = $listsitemaps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="list-group-item list-group-item-action list-group-item-light sitemap-edit <?php echo e($index === 0 ? 'active' : ''); ?>" data-id="<?php echo e($index); ?>" data-type="<?php echo e($list->type); ?>">
                                                        <?php if($list->type == 'htmlsitemaps'): ?>
                                                            General Settings
                                                        <?php else: ?>
                                                            <?php echo e(ucwords($list->type)); ?>
                                        ...
                                        <div class="col-12 col-md-9 second-right p-0">
                                            ...
                                            <div id="html-sitemap-section" style="display: none;">
                                                <form id="myform" action="<?php echo e(route('sitemapsetting.storeupdate')); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <div id="page-sitemap-section" style="display: none;">
                                                <form action="<?php echo e(route('sitemapsetting.storeupdate')); ?>" method="POST" id="myform1">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="type" id="sitemapType1" value="pages">
                                                    <div class="card-body card-inner">
                                                        <div class="row align-items-center mb-5">
                                                            <div class="col-sm-12">
                                                                <input class="form-control" type="text" value="Sitemap URL: <?php echo e(route('pagefront.xml')); ?>" disabled style="border-left: 5px solid #8b8b8b;">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row align-items-center mt-5">
                                                            ...
                                                            <div class="col-sm-12 select-border-line">
                                                                <select class="form-select select2" name="pages[]" id="pagesSelect" multiple data-placeholder="Select Pages">
                                                                    <?php $__currentLoopData = $pagesSitemap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php
                                                                            $path = trim(parse_url($pageUrl, PHP_URL_PATH), '/');
                                                                            $displayName = $path === '' ? 'home' : str_replace('-', ' ', $path);
                                                                        ?>
                                                                        <option value="<?php echo e($pageUrl); ?>"><?php echo e($displayName); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row align-items-center mt-5">
                                                            <div class="col-sm-5 label-sec">
                                                                <label class="form-label">Exclude in Residential Type</label>
                                                            </div>
                                                            <div class="col-sm-12 select-border-line">
                                                                <select class="form-select select2" name="residential[]" id="residentialid" multiple data-placeholder="Select Pages">
                                                                    <?php $__currentLoopData = $residentialSitemap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $residentialUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php
                                                                            $path = trim(parse_url($residentialUrl, PHP_URL_PATH), '/');
                                                                            $displayName = $path === '' ? 'home' : str_replace('-', ' ', $path);
                                                                        ?>
                                                                        <option value="<?php echo e($residentialUrl); ?>"><?php echo e($displayName); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row align-items-center mt-5">
                                                            <div class="col-sm-5 label-sec">
                                                                <label class="form-label">Exclude in Commercials Type</label>
                                                            </div>
                                                            <div class="col-sm-12 select-border-line">
                                                                <select class="form-select select2" name="commercials[]" id="commercialsid" multiple data-placeholder="Select Pages">
                                                                    <?php $__currentLoopData = $commercialSitemap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $commercialUrl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php
                                                                            $path = trim(parse_url($commercialUrl, PHP_URL_PATH), '/');
                                                                            $displayName = $path === '' ? 'home' : str_replace('-', ' ', $path);
                                                                        ?>
                                                                        <option value="<?php echo e($commercialUrl); ?>"><?php echo e($displayName); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                            ...
                                            <div id="post-sitemap-section" style="display: none;">
                                                <form id="postform" action="<?php echo e(route('sitemapsetting.storeupdate')); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="type" id="sitemapType2" value="posts">
                                                    <div class="card-body card-inner">
                                                        <div class="row align-items-center mb-5">
                                                            <div class="col-sm-12">
                                                                <input class="form-control" type="text" value="Sitemap URL: <?php echo e(route('postfront.xml')); ?>" disabled style="border-left: 5px solid #8b8b8b;">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row align-items-center mt-5">
                                                            ...
                                                            <div class="col-sm-12 select-border-line">
                                                                <select class="form-select select2" name="post[]" id="postsSelect" multiple data-placeholder="Select Posts">
                                                                    ...
                                                                    <?php $__currentLoopData = $blogSitemap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($blog['url']); ?>"><?php echo e($blog['title']); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                        </div>
...
<form id="resetForm" method="POST" action="<?php echo e(route('sitemapsetting.reset')); ?>">
    <?php echo csrf_field(); ?>
...
$(document).on('click', '.sitemap-edit', function () {
    ...
    $.ajax({
        url: "<?php echo e(route('sitemap-setting.edit')); ?>",
        method: "POST",
...
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/clarkandsonsdoors.com/public_html/resources/views/sitemap-setting/index.blade.php ENDPATH**/ ?>