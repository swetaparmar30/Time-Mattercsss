                ...
                <?php if(!empty($why_choose->why_choose_img1)): ?>
                    ...
                    <?php if(!empty($why_img->name)): ?>
                        <img src="<?php echo e(asset('uploads/' . $why_img->name)); ?>" alt="<?php echo e($why_img->alt_text); ?>" width="810"
                            height="810" class="img-fluid desktop-img 1">
                    <?php else: ?>
                        <img src="<?php echo e(asset('front-assets/src/images/why-choose-us-img.webp ')); ?>" alt="" width="810"
                            height="810" class="img-fluid desktop-img 2">
                    <?php endif; ?>
                <?php else: ?>
                    <img src="<?php echo e(asset('front-assets/src/images/why-choose-us-img.webp ')); ?>" alt="" width="810"
                        height="810" class="img-fluid desktop-img 3">
                <?php endif; ?>
...
</section><?php /**PATH C:\wamp64\www\Time\9-april\resources\views/frontend/includes/why-choose-us.blade.php ENDPATH**/ ?>