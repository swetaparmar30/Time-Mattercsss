                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor" id="bannersubtitle"
                                                    name="bannersubtitle"><?php echo e(isset($hollowmetaldoors->bannersubtitle) ? $hollowmetaldoors->bannersubtitle : ''); ?></textarea>
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor" id="bannerdescription"
                                                    name="bannerdescription"><?php echo e(isset($hollowmetaldoors->bannerdescription) ? $hollowmetaldoors->bannerdescription : ''); ?></textarea>
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor"
                                                    ...
                                                    name="section2_description"><?php echo e(isset($hm_d_section2->section2_description) ? $hm_d_section2->section2_description : ''); ?></textarea>
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor"
                                                    ...
                                                    name="section3_description"><?php echo e(isset($hm_d_section3->section3_description) ? $hm_d_section3->section3_description : ''); ?></textarea>
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor"
                                                    ...
                                                    name="section4_description"><?php echo e(isset($hm_d_section4->section4_description) ? $hm_d_section4->section4_description : ''); ?></textarea>
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor"
                                                    ...
                                                    name="section5_description"><?php echo e(isset($hm_d_section5->section5_description) ? $hm_d_section5->section5_description : ''); ?></textarea>
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor"
                                                    ...
                                                    id="section6_description"><?php echo e(isset($hm_d_section6->section6_description) ? $hm_d_section6->section6_description : ''); ?></textarea>
                                            </div>
                                            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                                <div class="upload-img-sec">
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor"
                                                    ...
                                                    id="section7_description"><?php echo e(isset($hm_d_section7->section7_description) ? $hm_d_section7->section7_description : ''); ?></textarea>
                                            </div>
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor"
                                                    ...
                                                    id="section8_description"><?php echo e(isset($hm_d_section8->section8_description) ? $hm_d_section8->section8_description : ''); ?></textarea>
                                            </div>
                                        ...
                                        <div class="row form-sec">
                                            ...
                                            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                <textarea class="form-control rich-text-editor"
                                                    ...
                                                    id="section9_description"><?php echo e(isset($hm_d_section9->section9_description) ? $hm_d_section9->section9_description : ''); ?></textarea>
                                            </div>
                                                ...
                                                <div class="row form-sec">
                                                    ...
                                                    <div
                                                        ...
                                                        <textarea class="form-control"
                                                            ...
                                                            data-parsley-required-message="Please Enter Description"><?php echo e(isset($hollowmetaldoors->meta_description) ? $hollowmetaldoors->meta_description : ''); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/clarkandsonsdoors.com/public_html/resources/views/hollowmetaldoors/index.blade.php ENDPATH**/ ?>