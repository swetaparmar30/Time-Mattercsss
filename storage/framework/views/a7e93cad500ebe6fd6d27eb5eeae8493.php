...
<?php $__env->startSection('content'); ?>
    ...
    <p>We are pleased to inform you that your account on <strong>Time Master</strong> has been reviewed and successfully <strong>approved</strong>.</p>
    ...
    <div class="button-wrapper">
        <a href="https://hamzahk15.sg-host.com/login" class="button">Log In to Dashboard</a>
    </div>

    <p>If you have any questions or require assistance, please don't hesitate to contact our support team.</p>
    
    <p>Welcome aboard!<br>The Time Master Team</p>
