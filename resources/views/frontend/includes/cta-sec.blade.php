                ...
                <a href="" class="cmn-btn banner-btn blue-arrow-btn">
                   <span class="text">Schedule a Free Consultation</span>
                    <span class="btn-circle">
                        <img decoding="async" src="{{ asset('front-assets/src/images/common-btn-blue-arrow.webp ') }}">
                    </span>
                </a>
            </div>
        ...
        <div class="row">
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 left-side content-sec">
                @if(isset($form->form_title) && $form->form_title != '')
                    <h2 class="mrbt-20">{{ $form->form_title ?? '' }}</h2>
                @endif
                @if(isset($form->form_short_desc) && $form->form_short_desc != '')
                    <p>{!! $form->form_short_desc ?? '' !!}</p>
                @endif

                <a href="{{ route('contact') }}/" class="cmn-btn banner-btn blue-arrow-btn">
                    <span class="text">{{ $form->btn_name ?? 'Schedule a Free Consultation' }}</span>
                    <span class="btn-circle">
                        <img decoding="async" src="{{ asset('front-assets/src/images/common-btn-blue-arrow.webp ') }}">
                    </span>
                </a>
