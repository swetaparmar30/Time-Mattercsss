...
$setting = App\Models\Setting::first();
    ...
    {{--
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/main.css') }}?v=0..1">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/about.css') }}?v=0.0.1">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/homepage.css') }}?v=0.0.1">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/header-footer.css') }}?v=0.0.1"> --}}
    ...
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/owl.theme.default.min.css') }}">
    ...
    <!------------- All css ---------------------------------->
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/custom_container.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/header-footer.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/common.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/home.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/service-page.css') }}">
    <link rel="stylesheet" href="{{ asset('front-assets/src/css/about-page.css') }}">
...
<body>
    ...
    <script src="{{ asset('front-assets/src/js/vendor/jquery-3.7.1.min.js') }}"></script>
    ...
    <script src="{{ asset('front-assets/src/js/vendor/magnific-popup.min.js') }}"></script>
        ...
        (function ($) {
            ...
            <div class="menu-toggle">
                ...
                <button class="navbar-toggler mobile-close-icon-new" type="button" aria-label="Close submenu">
                    <img src="{{ asset('front-assets/src/images/close-icon.svg') }}" alt="Close" width="25" height="25" class="close-icon" />
                </button>
            </div>
        </div>`;
